...
def infall_plots():
    ...
    for i in M:
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.10/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.20/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.30/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.40/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.50/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.60/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.70/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.80/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN0.90/')
        make_everything(100000, 'split_infall_profile_with_shock/M' + i + 'IN1.00/')
